...
def inserir_consulta(request, id):
    if request.method == 'POST':
        ...
        if form_consulta.is_valid():
            ...
            peso_consulta = form_consulta.cleaned_data["peso_consulta"]
            ...
            consulta_nova = consulta.ConsultaPet(pet=pet, motivo_consulta=motivo_consulta, peso_consulta=peso_consulta,
